...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1776172484);
user_pref("app.update.lastUpdateTime.background-update-timer", 1776172484);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1776172484);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1776172484);
user_pref("app.update.lastUpdateTime.region-update-timer", 1776172484);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1776172543);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1776172484);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1776172484);
user_pref("app.update.migrated.updateDir3.E5C1E91F98AA7CC6", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "9d122396-ccd9-47fe-bdcd-53e49acd91ad");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1776172455);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{c4e752a9-b324-474c-a0d8-1b9b81456dec}");
...
user_pref("browser.startup.lastColdStartupCheck", 1776172544);
...
user_pref("captchadetection.lastSubmission", 1776172);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "3aeed6cf-fe17-4479-a6e1-ff2f7b4acb08");
user_pref("datareporting.dau.cachedUsageProfileID", "2ad3f76f-42cb-44f9-8374-a8d752fb6727");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"ddf0cb04-cfc9-4ce2-b9cf-acd723611fed\",\"formautofill@mozilla.org\":\"502624dc-5378-491a-867f-dfe5aaa293da\",\"ipp-activator@mozilla.com\":\"6c8326f4-a70a-4b73-907d-485f735ffdcd\",\"pictureinpicture@mozilla.org\":\"c4861718-49b1-4a3e-a313-81605fff055a\",\"addons-search-detection@mozilla.com\":\"c3753b7b-c7de-47ac-aee3-4344cf7ec982\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"23568e6d-7935-4a67-84d9-5d519ecfd250\",\"default-theme@mozilla.org\":\"6643348f-8f68-4ccf-b076-6ad546baa1a5\"}");
...
user_pref("media.gmp-manager.lastCheck", 1776172590);
user_pref("media.gmp-manager.lastEmptyCheck", 1776172590);
...
user_pref("nimbus.profileId", "cd3c81f8-69d9-4196-8339-fa4bd23f0849");
...
user_pref("toolkit.profiles.storeID", "9c2399c0");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1776172539);
